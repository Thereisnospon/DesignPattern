...
[简单工厂模式（Simple Factory）：](https://github.com/Thereisnospon/DesignPattern/tree/master/simple_factory)

重要程度：4 （5为满分）

[工厂方法模式（Factory Method）](https://github.com/Thereisnospon/DesignPattern/tree/master/factory_method)
...
[抽象工厂模式（Abstract Factory）](https://github.com/Thereisnospon/DesignPattern/tree/master/abstract_factory)
...
[建造者模式（Builder](https://github.com/Thereisnospon/DesignPattern/tree/master/builder)
...
[原型模式（Prototype）](https://github.com/Thereisnospon/DesignPattern/tree/master/clone)
...
[单例模式（Singleton）](https://github.com/Thereisnospon/DesignPattern/tree/master/singleton)
...
[适配器模式(Adapter)](https://github.com/Thereisnospon/DesignPattern/tree/master/adapter)
...
[桥接模式(Bridge)](https://github.com/Thereisnospon/DesignPattern/tree/master/bridge)
...
[装饰模式(Decorator)](https://github.com/Thereisnospon/DesignPattern/tree/master/decorator)
...
[外观模式(Facade)](https://github.com/Thereisnospon/DesignPattern/tree/master/facade)
...
[享元模式(Flyweight)](https://github.com/Thereisnospon/DesignPattern/tree/master/flyweight)
...
享元模式通过共享技术使得系统中的对象个数大大减少了，同时享元模式使用了内部状态和外部状态，同时外部状态相对独立，不会影响到内部状态，所以享元模式能够使得享元对象在不同的环境下被
...
[代理模式(Proxy)](https://github.com/Thereisnospon/DesignPattern/tree/master/proxy)
...
[职责链模式(Chain of Responsibility)](https://github.com/Thereisnospon/DesignPattern/tree/master/responsibility_chain)
...
[命令模式(Command)](https://github.com/Thereisnospon/DesignPattern/tree/master/command)
...
[迭代器模式(Iterator)](https://github.com/Thereisnospon/DesignPattern/tree/master/iterator)
...
[中介者模式(Mediator)](https://github.com/Thereisnospon/DesignPattern/tree/master/mediator)
...
[备忘录模式(Memento)](https://github.com/Thereisnospon/DesignPattern/tree/master/memoto)
...
[观察者模式(Observer)](https://github.com/Thereisnospon/DesignPattern/tree/master/observer)
...
[状态模式(State)](https://github.com/Thereisnospon/DesignPattern/tree/master/state)
...
[策略模式(Strategy)](https://github.com/Thereisnospon/DesignPattern/tree/master/strategy)
...
[模板方法模式(Template Method)](https://github.com/Thereisnospon/DesignPattern/tree/master/template_method)
...
[访问者模式(Visitor)](https://github.com/Thereisnospon/DesignPattern/tree/master/visitor)
